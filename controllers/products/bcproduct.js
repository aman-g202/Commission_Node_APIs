...
exports.deleteBcProduct = (req, res, next) => {
    ...
    BcProduct
        ...
        .then(prod => {
            ...
            return BcProduct.destroy({ where: { id: id } });
        })
        .then(result => {
...
exports.fetchAllBcProducts = (req, res, next) => {
    ...
    BcProduct
        ...
        .then(count => {
            ...
            return BcProduct.findAll(searchQuery);
        })
        .then(bcproducts => {
...
exports.uploadExcel = (req, res, next) => {
    ...
    Agent
        .findAll({ where: { agentId: { [Op.in]: columnAgentId } }, attributes: ['id', 'agentId'] })
        .then(agents => {
            ...
            return BcProduct.findAll({ where: { id: { [Op.in]: productIds } }, attributes: ['id', 'price', 'companyComission'] });
        })
        .then(prodsInfo => {
            ...
            return sequelize.transaction(t => {
                return BcCommission
                    .create({ month, createdAt, createdBy: req.userId }, { transaction: t })
                    .then(result => {
                        ...
                        return async.eachSeries(parsedData, (item, cb) => {
                            ...
                            let bcCommissionReportData = {
                                ...
                                falseTransactionCommissionDeduced: item['Commission Deducted for false Transactions (Round-Tripping)'],
                            ...
                            BcCommissionReport
                                .create(bcCommissionReportData, { transaction: t })
                                .then(result => {
